...
"""Refactored main application with clean router structure"""
...
# Legacy redirect for /api/health
@app.get("/api/health")
async def legacy_health_redirect():
    """Redirect legacy health endpoint"""
    return {"status": "healthy", "note": "Please use /api/v1/health"}
