  ...
  const processBotResponse = async (
    ...
    try {
      ...
      if (session && session.access_token) {
        // User is authenticated - use full RAG endpoint
        console.log("Using authenticated RAG endpoint");
        response = await fetch(`${BACKEND_URL}/api/rag/test`, {
          method: "POST",
          headers: {
