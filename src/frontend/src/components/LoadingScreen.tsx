  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-green-400/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-md mx-auto px-6">
        ...
        <div className="mb-6">
          <div className="relative w-16 h-16 mx-auto">
            ...
            <div className="absolute inset-2 border-2 border-transparent border-t-green-300 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
          </div>
        </div>
